        ...
        headers: [
          {
            ...
            value: [
              ...
              "frame-src 'self' http://localhost:8080 http://159.89.205.91:3002",
              "connect-src 'self' http://localhost:5000 http://localhost:8080 http://159.89.205.91:3002 ws://localhost:8080",
            ].join('; '),
          },
        ],
      },
