                                                ...
                                                <td className="px-6 py-0 text-center">
                                                    <div className="h-[80px] flex items-center justify-center gap-2">
                                                        <button
                                                            ...
                                                            className="w-8 h-8 rounded-lg bg-gray-50 border border-border flex items-center justify-center text-gray-500 hover:bg-primary/20 hover:text-primary cursor-pointer hover:scale-110 hover:ring-2 hover:ring-primary/40 hover:ring-offset-1 transition-all duration-300 shadow-sm"
                                                            title="Quick Preview"
                                                        >
                                                        ...
                                                        <button
                                                            ...
                                                            className="w-8 h-8 rounded-lg bg-gray-50 border border-border flex items-center justify-center text-gray-500 hover:bg-orange-500/20 hover:text-orange-500 cursor-pointer hover:scale-110 hover:ring-2 hover:ring-orange-500/40 hover:ring-offset-1 transition-all duration-300 shadow-sm"
                                                            title="Rename"
                                                        >
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path></svg>
                                                        </button>
                                                        <Link
                                                            href={`/dashboard/templates/edit/${t._id}`}
                                                            className="w-8 h-8 rounded-lg bg-gray-50 border border-border flex items-center justify-center text-gray-500 hover:bg-blue-500/20 hover:text-blue-500 cursor-pointer hover:scale-110 hover:ring-2 hover:ring-blue-500/40 hover:ring-offset-1 transition-all duration-300 shadow-sm"
                                                        ...
                                                        <button
                                                            ...
                                                            className="w-8 h-8 rounded-lg bg-gray-50 border border-border flex items-center justify-center text-gray-500 hover:bg-red-500/20 hover:text-red-500 cursor-pointer hover:scale-110 hover:ring-2 hover:ring-red-500/40 hover:ring-offset-1 transition-all duration-300 shadow-sm"
                                                            title="Delete"
                                                        >
